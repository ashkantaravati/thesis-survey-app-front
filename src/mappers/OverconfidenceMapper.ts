...
export default class OverconfidenceMapper implements ITwoWayMapper {
  createDtoFromModel(
    ...
    return {
      ...
      question_2_min: model.q02.response.min,
      question_2_max: model.q02.response.max,
      question_3_min: model.q03.response.min,
      question_3_max: model.q03.response.max,
      question_4_min: model.q04.response.min,
      question_4_max: model.q04.response.max,
      question_5_min: model.q05.response.min,
      question_5_max: model.q05.response.max,
      question_6_min: model.q06.response.min,
      question_6_max: model.q06.response.max,
      question_7_min: model.q07.response.min,
      question_7_max: model.q07.response.max,
      question_8_min: model.q08.response.min,
      question_8_max: model.q08.response.max,
      question_9_min: model.q09.response.min,
      question_9_max: model.q09.response.max,
      question_10_min: model.q10.response.min,
      question_10_max: model.q10.response.max,
    };
  }
  createModelFromDto(
